...
void Pistol::_register_methods() {
    ...
    register_property<Pistol, double>   ("dead_zone/top",           &Pistol::_ANIM_DEAD_ZONE_TOP, double(0));
    register_property<Pistol, double>   ("dead_zone/bottom",        &Pistol::_ANIM_DEAD_ZONE_BOTTOM, double(40));

    register_property<Pistol, Vector2> ("position/offset",          &Pistol::_OFFSET, Vector2(45, -39));
    register_property<Pistol, Vector2> ("position/climb_offset",    &Pistol::_CLIMB_OFFSET, Vector2(7, 64));
}
